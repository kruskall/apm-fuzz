...
type contextRequest struct {
	...
	// request body.
	Body *int `json:"body" validate:"inputTypes=string;object"`
...
type contextRequestURL struct {
	...
	Port *int `json:"port" validate:"inputTypes=string;int,targetType=int,maxLength=1024"`
...
type contextServiceTarget struct {
	// _ struct{} // removed `validate:"requiredAnyOf=type;name"`
...
type errorEvent struct {
	// _ struct{} // removed `validate:"requiredAnyOf=exception;log"`
...
type errorException struct {
	// _ struct{} // removed `validate:"requiredAnyOf=message;type"`
	// Attributes of the exception.
	Attributes map[string]any `json:"attributes"`
	// Code that is set when the error happened, e.g. database error code.
	Code *int `json:"code" validate:"inputTypes=string;int,maxLength=1024"`
...
type metricsetSampleValue struct {
	...
	// _ struct{} // removed `validate:"requiredAnyOf=value;values"`
...
type span struct {
	// _ struct{} // removed `validate:"requiredAnyOf=start;timestamp"`
	// Timestamp holds the recorded time of the event, UTC based and formatted
	// as microseconds since Unix epoch
	Timestamp *time.Time `json:"timestamp"`
...
type stacktraceFrame struct {
	// _ struct{} // removed `validate:"requiredAnyOf=classname;filename"`
