...
type contextRequest struct {
	...
	Headers *http.Header `json:"he"`
	// HTTPVersion holds information about the used HTTP version.
	HTTPVersion *string `json:"hve" validate:"maxLength=1024"`
	// Method holds information about the method of the HTTP request.
	Method *string `json:"mt" validate:"required,maxLength=1024"`
}
...
type contextService struct {
	...
	Environment *string `json:"en" validate:"maxLength=1024"`
	...
	Name *string `json:"n" validate:"maxLength=1024,pattern=patternAlphaNumericExt"`
	...
	Version *string `json:"ve" validate:"maxLength=1024"`
}

type contextServiceAgent struct {
	// Name of the APM agent capturing information.
	Name *string `json:"n" validate:"maxLength=1024"`
...
type errorEvent struct {
	// _ struct{} // removed `validate:"requiredAnyOf=ex;log"`
	...
	// of this event.
	Culprit *string `json:"cl" validate:"maxLength=1024"`
	...
	// transaction or span.
	ParentID *string `json:"pid" validate:"requiredIfAny=xid;tid,maxLength=1024"`
	// TraceID holds the hex encoded 128 random bits ID of the correlated trace.
	TraceID *string `json:"tid" validate:"requiredIfAny=xid;pid,maxLength=1024"`
	// TransactionID holds the hex encoded 64 random bits ID of the correlated
	// transaction.
	TransactionID *string `json:"xid" validate:"maxLength=1024"`
...
type errorException struct {
	// _ struct{} // removed `validate:"requiredAnyOf=mg;t"`
	...
	Code *int `json:"cd" validate:"inputTypes=string;int,maxLength=1024"`
...
type errorLog struct {
	...
	// being replaced.
	Message *string `json:"mg" validate:"required"`
	...
	ParamMessage *string `json:"pmg" validate:"maxLength=1024"`
...
type metadataService struct {
	...
	// Name of the monitored service.
	Name *string `json:"n" validate:"required,minLength=1,maxLength=1024,pattern=patternAlphaNumericExt"`
	// Runtime holds information about the language runtime running the
	// monitored service
...
type metadataServiceAgent struct {
	// Name of the APM agent capturing information.
	Name *string `json:"n" validate:"required,minLength=1,maxLength=1024"`
	// Version of the APM agent capturing information.
	Version *string `json:"ve" validate:"required,maxLength=1024"`
}
...
type metadataServiceLanguage struct {
	// Name of the used programming language
	Name *string `json:"n" validate:"required,maxLength=1024"`
	// Version of the used programming language
	Version *string `json:"ve" validate:"maxLength=1024"`
}
...
type metricsetSpanRef struct {
	...
	Subtype *string `json:"su" validate:"maxLength=1024"`
...
type spanContextDestination struct {
	...
	// IPv4 (e.g. '127.0.0.1')
	// IPv6 (e.g. '::1')
	Address *string `json:"ad" validate:"maxLength=1024"`
...
type spanContextDestinationService struct {
	...
	// DEPRECATED: this field will be removed in a future release
	Resource *string `json:"rc" validate:"required,maxLength=1024"`
...
type spanContextHTTP struct {
	// Method holds information about the method of the HTTP request.
	Method *string `json:"mt" validate:"maxLength=1024"`
...
type stacktraceFrame struct {
	...
	ColumnNumber *int `json:"co"`
	// LineNumber of the frame.
	LineNumber *int `json:"li"`
}
...
type transaction struct {
	...
	// TraceID holds the hex encoded 128 random bits ID of the correlated trace.
	TraceID *string `json:"tid" validate:"required,maxLength=1024"`
	...
	Result *string `json:"rt" validate:"maxLength=1024"`
	// ID holds the hex encoded 64 random bits ID of the event.
	ID *string `json:"id" validate:"required,maxLength=1024"`
	// Name is the generic designation of a transaction in the scope of a
	// single service, eg: 'GET /users/:id'.
	...
	// ParentID holds the hex encoded 64 random bits ID of the parent
	// transaction or span.
	ParentID *string `json:"pid" validate:"maxLength=1024"`
...
type transactionSession struct {
	...
	// different sessions.
	Sequence *int `json:"seq" validate:"min=1"`
}
...
type transactionSpanCount struct {
	...
	Started *int `json:"sd" validate:"required"`
}
...
type user struct {
	// Domain of the user
	Domain *string `json:"ud" validate:"maxLength=1024"`
	// ID identifies the logged in user, e.g. can be the primary key of the user
	ID *int `json:"id" validate:"maxLength=1024,inputTypes=string;int"`
	// Email of the user.
	Email *string `json:"em" validate:"maxLength=1024"`
	// Name of the user.
	Name *string `json:"un" validate:"maxLength=1024"`
}
